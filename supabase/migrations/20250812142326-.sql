-- Full migration: add organization_id columns, helper functions, triggers, and strict org-aware RLS policies
...
-- 2) Trigger function to auto-fill organization_id
...
-- 3) Add organization_id to tenant tables + indexes + triggers
-- invoices
...
-- 5) Drop any previous policies (old permissive and our new ones if partial runs)
...
-- 6) Create new org-aware policies
-- invoices
...
-- 7) Organizations table policies
